anychart.onDocumentReady(function () {
    ...
    // add data
    const data = [
        {from: "Genre Related", to: null, value: 800, color: '#999EA2'},
        {from: "Structure Related", to: null, value: 560, color: '#999EA2'},
        {from: "Recommend", to: null, value: 1000, color: '#999EA2'},
        ...
        {from: "Personal Refections", to: "Imagination", value: 9, color: '#999EA2'},
    ...
    chart.container("sankey_quotes_container");
